      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <Link to="/" className="inline-block">
            <h1 className="text-3xl font-bold text-indigo-600 mb-2">📚 MindBridge</h1>
          </Link>
        ...
        <div className="bg-white py-8 px-6 shadow-xl rounded-2xl">
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn btn-primary w-full py-3 px-4 text-sm"
            >
              Sign In
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="btn btn-secondary mt-4 w-full py-3 px-4 text-sm"
            >
              Sign up
